  ...
  return (
    <div className='h-full bg-primary/30'>
      ...
      <div className='flex flex-col w-full max-w-[700px]'>
        <motion.h2 variants={fadeIn('up', 0.2)} initial='hidden' animate='show' exit='hidden'  className='h2 text-center mb-12'> Lets <span className='text-accent'>connect</span></motion.h2>
        <motion.form
